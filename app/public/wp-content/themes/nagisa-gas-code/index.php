...
<div class="hero-image">
    <div class="swiper-container for_sp">
        ...
        <div class="swiper-wrapper">
            <!-- Slides -->
            <div class="swiper-slide"><img src="<?php echo $upload_dir[
                'baseurl'
            ]; ?>/mainimage_sp_05.jpg.webp" alt="想像して下さいお湯が出ない冬のお風呂を"></div>
            <div class="swiper-slide"><img src="<?php echo $upload_dir[
                'baseurl'
            ]; ?>/mainimage_sp_02.jpg.webp" alt="毎日の暮らしを快適、安全に"></div>
            <div class="swiper-slide"><img src="<?php echo $upload_dir[
                'baseurl'
            ]; ?>/mainimage_sp_03.jpg.webp" alt="毎日の暮らしを快適、安全に"></div>
        </div>
    ...
    <div class="swiper-container for_pc">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide"><img src="<?php echo $upload_dir[
                'baseurl'
            ]; ?>/mainimage_05.jpg.webp" alt="想像して下さいお湯が出ない冬のお風呂を"></div>
            <div class="swiper-slide"><img src="<?php echo $upload_dir[
                'baseurl'
            ]; ?>/mainimage_02.jpg.webp" alt="毎日の暮らしを快適、安全に"></div>
            <div class="swiper-slide"><img src="<?php echo $upload_dir[
                'baseurl'
            ]; ?>/mainimage_03.jpg.webp" alt="毎日の暮らしを快適、安全に"></div>
        </div>
            <!-- If we need pagination -->
        <div class="swiper-pagination"></div>
            ...
            <div class="mask">
                <div class="secInner">
                    ...
                    <div class="leftBox">
                        ...
                        <p class="plane">ベテランスタッフが多数在籍しており、確かな品質と<br class="for_pc">安全な作業をご提供いたします。<br class="for_pc">また、当社の作業員は大手ガス会社にてお客様対応研修を<br
                    class="for_pc">終えておりますので、お客様のご要望・ご不安を<br class="for_pc">取り除いてから作業に取り掛からせて頂きます。</p>
