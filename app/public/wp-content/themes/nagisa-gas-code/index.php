...
<div class="swiper-container for_pc">
    <!-- Additional required wrapper -->
    <div class="swiper-wrapper">
        <!-- Slides -->
        <div class="swiper-slide"><img src="<?php echo $upload_dir['baseurl']; ?>/mainimage_05.jpg.webp" alt="想像して下さいお湯が出ない冬のお風呂を"></div>
        <div class="swiper-slide"><img src="<?php echo $upload_dir['baseurl']; ?>/mainimage_02.jpg.webp" alt="毎日の暮らしを快適、安全に"></div>
        <div class="swiper-slide"><img src="<?php echo $upload_dir['baseurl']; ?>/mainimage_03.jpg.webp" alt="毎日の暮らしを快適、安全に"></div>
    </div>
...
<div class="swiper-container for_sp">
    <!-- Additional required wrapper -->
    <div class="swiper-wrapper">
        <!-- Slides -->
        <div class="swiper-slide"><img src="<?php echo $upload_dir['baseurl']; ?>/mainimage_sp_05.jpg.webp" alt="想像して下さいお湯が出ない冬のお風呂を"></div>
        <div class="swiper-slide"><img src="<?php echo $upload_dir['baseurl']; ?>/mainimage_sp_02.jpg.webp" alt="毎日の暮らしを快適、安全に"></div>
        <div class="swiper-slide"><img src="<?php echo $upload_dir['baseurl']; ?>/mainimage_sp_03.jpg.webp" alt="毎日の暮らしを快適、安全に"></div>
    </div>
        <!-- If we need pagination -->
    <div class="swiper-pagination"></div>
                ...
                <ul class="list_01">
                    <li>
                        <a href="<?php echo home_url(); ?>/product/gas/">
                            <div class="imgBox"><img src="<?php echo $upload_dir['baseurl']; ?>/product_01.jpg.webp" alt="給湯器"></div>
                            <div class="textBox">給湯器</div>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo home_url(); ?>/product/kitchen/">
                            <div class="imgBox"><img src="<?php echo $upload_dir['baseurl']; ?>/product_02.jpg.webp" alt="キッチン・厨房機器"></div>
                            <div class="textBox">キッチン・厨房機器</div>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo home_url(); ?>/product/bath/">
                            <div class="imgBox"><img src="<?php echo $upload_dir['baseurl']; ?>/product_04.jpg.webp" alt="浴室暖房乾燥機"></div>
